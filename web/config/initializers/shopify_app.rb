...
ShopifyApp.configure do |config|
  ...
  config.api_key = ENV.fetch("SHOPIFY_API_KEY", "de4fb4a994991bbb3d947b2439cac414").presence
  config.secret = ENV.fetch("SHOPIFY_API_SECRET", "85fb588bf3cef8ac84daacb235e66aaa").presence
